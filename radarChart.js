...
function RadarChart(id, data, options) {
	...
	axis.append("text")
		...
		.text(function(d){
			if(d === "GP")
				...
				return "Spatial Presence";
			else if(d === "INV")
				return "Involvement";
			else if(d === "REAL")
				return "Experienced Realism";
	...
	blobCircleWrapper.selectAll(".radarInvisibleCircle")
		...
		.on("mouseover", function(d,i) {
			...
			if(d.value == 1)
			{
				tooltipText = "Low" + " (M = " + d.mean + ", SD = " + d.std + ")";                 
			}
			else if(d.value == 2)
			{
				tooltipText = "Moderate" + " (M = " + d.mean + ", SD = " + d.std + ")";
			}
			else if(d.value == 3)
			{
				tooltipText = "High" + " (M = " + d.mean + ", SD = " + d.std + ")";
			}
			else if(d.value == 4)
			{
			...
			{
				tooltipText = "Exceptional" + " (M = " + d.mean + ", SD = " + d.std + ")";
			}
			else
			{
				tooltipText = "Unclassified";
			}
